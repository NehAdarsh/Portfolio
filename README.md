...
| Project Link  | Analysis Area | Description  |
| ------------- | ------------- | ------------ |
| [Movie Recommender System](https://github.com/NehAdarsh/Data-Projects-SQL-Python-Tableau-Excel/tree/main/Python-Projects/Movie-Recommender-System) | Data Preprocessing, Machine Learning Model Building, Converting the model to a Streamlit Website  | Developed a content based movie recommender system based on cosine similarity by utilizing machine learning algorithms that suggest movies based on their content similarity. Lastly, converted the machine learning model to an app using streamlit.|
